...
public class SpLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public SpLoginFilter(AuthenticationManager authenticationManager,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        UsernamePasswordAuthenticationToken authToken =
                new UsernamePasswordAuthenticationToken(userLogin.getUsername(),userLogin.getPassword(),null);
